...
namespace Chat.Interfaces
{
    ...
    {
        Task<ConversationDto?> GetOrCreateConversationAsync(string requestingUserId, string targetUserId, int storeId, int? orderId = null, int? productId = null, int? ticketId = null);
